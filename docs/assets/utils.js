...
var colorbrewer = {
  ...
  GnBu: {
    3: ["#e0f3db", "#a8ddb5", "#43a2ca"], 4: ["#f0f9e8", "#bae4bc", "#7bccc4", "#2b8cbe"],
...
function sliderGen(dims) {
  ...
  function renderSlider(divin) {
    ...
    */
    ...
    handle.moveToFront()
    return {
      xval: function () { return curr_xval },
      tick: updateTicks,
      init: function () {
