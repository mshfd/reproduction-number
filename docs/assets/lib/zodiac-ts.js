...
zodiac.SimpleExponentialSmoothing = function(data, alpha)
{
	if(data == null)
	{
...
zodiac.SimpleExponentialSmoothing.prototype.predict = function()
{
	var forecast = Array();
	forecast[0] = null;
...
zodiac.SimpleExponentialSmoothing.prototype.getForecast = function()
{
...
zodiac.SimpleExponentialSmoothing.prototype.computeMeanSquaredError = function()
{ 
	var SSE = 0.0;
	var n = 0;
...
zodiac.SimpleExponentialSmoothing.prototype.optimizeParameter = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
zodiac.DoubleExponentialSmoothing = function(data, alpha)
{
	if(data == null)
	{
		throw "data parameter is null";
...
zodiac.DoubleExponentialSmoothing.prototype.predict =function (horizon)
{
...
zodiac.DoubleExponentialSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		return null;
...
zodiac.DoubleExponentialSmoothing.prototype.computeMeanSquaredError = function()
{ 
	var SSE = 0.0;
	var n = 0;
	for(var i = 0; i < this.data.length; ++i)
...
zodiac.DoubleExponentialSmoothing.prototype.optimizeParameter = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
/*Holt smoothing */
zodiac.HoltSmoothing = function(data, alpha, gamma)
{
	if(data == null)
	{
		throw "data parameter is null";
...
zodiac.HoltSmoothing.prototype.predict =function (horizon)
{
	A = Array();
	B = Array();
...
zodiac.HoltSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		return null;
...
zodiac.HoltSmoothing.prototype.computeMeanSquaredError = function()
{ 
	var SSE = 0.0;
	var n = 0;
	for(var i = 0; i < this.data.length; ++i)
...
zodiac.HoltSmoothing.prototype.optimizeParameters = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
zodiac.HoltWintersSmoothing = function(data, alpha, gamma, delta, seasonLength, mult)
{
	if(data == null)
	{
		throw "data parameter is null";
...
zodiac.HoltWintersSmoothing.prototype.predict =function ()
{
	if(this.mult)
	{
...
zodiac.HoltWintersSmoothing.prototype.predictAdd = function()
{
	A = Array();
	B = Array();
	S = Array();
...
zodiac.HoltWintersSmoothing.prototype.predictMult = function()
{
	A = Array();
	B = Array();
	S = Array();
...
zodiac.HoltWintersSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		this.predict();
...
zodiac.HoltWintersSmoothing.prototype.computeMeanSquaredError = function()
{ 
	var SSE = 0.0;
	var n = 0;
	for(var i = 0; i < this.data.length; ++i)
...
zodiac.HoltWintersSmoothing.prototype.optimizeParameters = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
zodiac.MovingAverage = function(data)
{
	if(data == null)
	{
		throw "data parameter is null";
...
zodiac.MovingAverage.prototype.smooth = function(order)
{
	if(order < 1)
	{
